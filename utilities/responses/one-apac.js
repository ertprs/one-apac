module.exports = (function() {
  function responses(accessToken, payload, recipientId, userId) {
    ...
    switch (payload) {
      case 'Home':
        queries.views.addView(menus.oneApac.home);
      ...
      case 'Agenda&Maps':
        queries.views.addView(menus.oneApac.agendaAndMaps);
      ...
      case 'Agenda':
        queries.views.addView(menus.oneApac.agenda);
      ...
      case 'Day1':
        queries.views.addView(menus.oneApac.agendaDayOne);
      ...
      case 'Day1Part1':
        queries.views.addView(menus.oneApac.agendaDayOnePartOne);
      ...
      case 'Day1Part2':
        queries.views.addView(menus.oneApac.agendaDayOnePartTwo);
      ...
      case 'Day1Part3':
        queries.views.addView(menus.oneApac.agendaDayOnePartThree);
      ...
      case 'Day2':
        queries.views.addView(menus.oneApac.agendaDayTwo);
      ...
      case 'Day2FullDayAgenda':
        queries.views.addView(menus.oneApac.agendaDayTwoFull);
      ...
      case 'Day2FullDayAgendaPart1':
        queries.views.addView(menus.oneApac.agendaDayTwoFullPartOne);
      ...
      case 'Day2FullDayAgendaPart2':
        queries.views.addView(menus.oneApac.agendaDayTwoFullPartTwo);
      ...
      case 'Day2BreakoutSessions':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakout);
      ...
      case 'Day2BreakoutSessionsPart1':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOne);
      ...
      case 'Day2BreakoutSessionsPart1Details1':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOneDetailsOne);
      ...
      case 'Day2BreakoutSessionsPart1Details2':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOneDetailsTwo);
      ...
      case 'Day2BreakoutSessionsPart1Details3':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOneDetailsThree);
      ...
      case 'Day2BreakoutSessionsPart1Details4':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOneDetailsFour);
      ...
      case 'Day2BreakoutSessionsPart1Details5':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOneDetailsFive);
      ...
      case 'Day2BreakoutSessionsPart1Details6':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartOneDetailsSix);
      ...
      case 'Day2BreakoutSessionsPart2':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartTwo);
      ...
      case 'Day2BreakoutSessionsPart2Details1':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartTwoDetailsOne);
      ...
      case 'Day2BreakoutSessionsPart2Details2':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartTwoDetailsTwo);
      ...
      case 'Day2BreakoutSessionsPart2Details3':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartTwoDetailsThree);
      ...
      case 'Day2BreakoutSessionsPart2Details4':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartTwoDetailsFour);
      ...
      case 'Day2BreakoutSessionsPart2Details5':
        queries.views.addView(menus.oneApac.agendaDayTwoBreakoutPartTwoDetailsFive);
      ...
      case 'Day2TrainingSessions':
        queries.views.addView(menus.oneApac.agendaDayTwoTraining);
      ...
      case 'Day2TrainingSessionsDetails1':
        queries.views.addView(menus.oneApac.agendaDayTwoTrainingDetailOne);
      ...
      case 'Day2TrainingSessionsDetails2':
        queries.views.addView(menus.oneApac.agendaDayTwoTrainingDetailTwo);
      ...
      case 'Day2TrainingSessionsDetails3':
        queries.views.addView(menus.oneApac.agendaDayTwoTrainingDetailThree);
      ...
      case 'Day2TrainingSessionsDetails4':
        queries.views.addView(menus.oneApac.agendaDayTwoTrainingDetailFour);
      ...
      case 'Day2TrainingSessionsDetails5':
        queries.views.addView(menus.oneApac.agendaDayTwoTrainingDetailFive);
      ...
      case 'DinnerEvents':
        queries.views.addView(menus.oneApac.agendaDinnerEvents);
      ...
      case 'DinnerEventsPart1':
        queries.views.addView(menus.oneApac.agendaDinnerEventsArtScience);
      ...
      case 'DinnerEventsPart2':
        queries.views.addView(menus.oneApac.agendaDinnerEventsMarquee);
      ...
      case 'ExperienceShowcase':
        queries.views.addView(menus.oneApac.experience);
      ...
      case 'ExperienceShowcaseBusiness':
        queries.views.addView(menus.oneApac.experienceBusiness);
      ...
      case 'ExperienceShowcaseCommunity':
        queries.views.addView(menus.oneApac.experienceCommunity);
      ...
      case 'ExperienceShowcasePeople':
        queries.views.addView(menus.oneApac.experiencePeople);
      ...
      case 'VenueMaps':
        queries.views.addView(menus.oneApac.maps);
      ...
      case 'VenueMapsBreakout':
        queries.views.addView(menus.oneApac.mapsBreakout);
      ...
      case 'Transport&Contacts':
        queries.views.addView(menus.oneApac.transportAndContacts);
      ...
      case 'Transportation':
        queries.views.addView(menus.oneApac.transportAndContactsTransportation);
      ...
      case 'TransportationMBS':
        queries.views.addView(menus.oneApac.transportAndContactsTransportationMBS);
      ...
      case 'Contacts':
        queries.views.addView(menus.oneApac.transportAndContactsContacts);
      ...
      case 'LipSyncBattle':
        queries.views.addView(menus.oneApac.lipSyncBattle);
      ...
      case 'Vote_Southeast Asia':
        ...
        queries.views.addView(menus.oneApac.lipSyncBattleVote + payloadRegion);
