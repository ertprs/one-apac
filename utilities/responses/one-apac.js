    ...
    switch (payload) {
      ...
      case 'Dinner Events Welcome Dinner':
        elements = [
          ...
          new Element('DPole', 'Dance with Dpole on B1', placeholder, [new Button('Discover More', 'web_url', 'https://instagram.com/dpole_arts')]),
          new Element('Miss Lou Duo', 'R&B and jazz soul with Miss Lou on L2', placeholder, [new Button('Discover More', 'web_url', 'https://instagram.com/hellomisslou')]),
          new Element('NationOne', 'Rock & Roll with NationOne on L3', placeholder, [new Button('Discover More', 'web_url', 'https://instagram.com/thebandnationone')])
        ];
